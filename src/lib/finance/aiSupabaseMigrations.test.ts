...
describe("accept_ai_consent / revoke_ai_consent RPCs (SQL text)", () => {
  ...
  it("revoke execute from public and anon, grant only to authenticated, for both RPCs", () => {
  ...
  it("ai_consents has only a SELECT-your-own-row policy — no client-writable policy", () => {
