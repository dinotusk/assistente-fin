    ...
    <div className="flex flex-col gap-3">
      <Panel>
        ...
        <div className="flex flex-col gap-2.5">
          {priorities.length === 0 && <p className="text-sm text-muted-foreground">Sem prioridades ainda.</p>}
          {priorities.map((item) => (
            <div key={item.id} className="rounded-2xl border border-border bg-secondary p-3.5">
              ...
              <span className="mt-0.5 block text-[11px] text-muted-foreground">Prioridade {item.rank}</span>
              <div className="mt-2.5 flex items-center justify-between">
                <button type="button" onClick={() => togglePriorityStatus(item.id)}>
                ...
                <div className="flex gap-1">
                  <button
                    ...
                    aria-label="Editar"
                    className="flex h-9 w-9 items-center justify-center rounded-xl bg-card text-muted-foreground"
                  >
                  ...
                  <button
                    ...
                    aria-label="Excluir"
                    className="flex h-9 w-9 items-center justify-center rounded-xl bg-card text-destructive"
                  >
