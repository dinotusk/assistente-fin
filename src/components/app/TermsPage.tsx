...
const SECTIONS: { title: string; anchor?: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Para funcionar, o Aval guarda algumas informações no armazenamento local do seu navegador (localStorage e sessionStorage), que é uma tecnologia diferente de cookies e não é enviada automaticamente a cada requisição. São elas: sua sessão de login; um registro local da sua escolha sobre o assistente de IA; as regras de categorização que você ensina ao app; os vigias que você configura; e preferências de navegação como o mês e o perfil que você está visualizando.",
      ...
      "O Aval registra um service worker no seu navegador. Ele só é usado para exibir notificações push quando você as ativa; fora isso fica inativo. Não armazena páginas nem dados financeiros em cache.",
